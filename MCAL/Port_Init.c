...
void Port_Init(uint8_t port_index, uint8_t pins_mask,uint32_t GPIO_PCTL_mask ){
	...
	case PORTA:	{volatile unsigned long delay;
				...
				GPIO_PORTA_CR_R |= pins_mask;				  //enable changes to  pins of the portA
				...
				GPIO_PORTA_DEN_R |= pins_mask;				  		//i made  pins of the portA digital 
				break;}	
	...
	case PORTB:	{volatile unsigned long delay;
				...
				GPIO_PORTB_CR_R |= pins_mask;					         //enable changes to  pins of the portB	
				...
				GPIO_PORTB_DEN_R |= pins_mask;			  					//i made  pins of the portB digital
				break;}	
	...
	case PORTC:	{volatile unsigned long delay;
				...
				GPIO_PORTC_CR_R |= pins_mask;					  //enable changes to  pins of the portC
				...
				GPIO_PORTC_DEN_R |= pins_mask;				  //i made  pins of the portC digital
				break;}	
	...
	case PORTD:	{volatile unsigned long delay;
		    ...
		    GPIO_PORTD_AMSEL_R &= ~pins_mask;              // Disable analog function
				...
				GPIO_PORTD_CR_R |= pins_mask;					  //enable changes to  pins of the portD
				GPIO_PORTD_DEN_R |= pins_mask;				  //i made  pins of the portD digital
				break;}	
	...
	case PORTE:	{volatile unsigned long delay;
				...
				GPIO_PORTE_CR_R |= pins_mask;					  //enable changes to  pins of the portE
				...
				GPIO_PORTE_DEN_R |= pins_mask;				  //i made  pins of the portE digital
				break;}	
	...
	case PORTF:	{volatile unsigned long delay;			
				...
				GPIO_PORTF_CR_R |= pins_mask;					  //enable changes to  pins of the portF
				...
				GPIO_PORTF_DEN_R |= pins_mask;				  //i made  pins of the portF digital
				break;}	
			}
}
